module.exports = [
    ...
    },
    {
        ...
        type: "color",
        category: "gray-palette",
        description: "The second gray in the grayscale palette. By default, used as the document text color.",
    ...
    },
    {
        ...
        type: "color",
        category: "gray-palette",
        description: "The fifth gray in the grayscale palette. By default, used as the disabled color.",
    ...
    },
    {
        ...
        type: "color",
        category: "gray-palette",
        description: "The sixth gray in the grayscale palette. By default, used as the border color.",
    ...
    },
    {
        ...
        description: "The primary color, often defined as the 'brand' color. By default, used for links and buttons.",
    ...
    },
    {
        ...
        type: "color",
        category: "semantic-palette",
        description: "The color used to define success states in meter elements.",
    ...
    },
    {
        ...
        type: "color",
        category: "semantic-palette",
        description: "The color used to define warning states in meter elements.",
    ...
    },
    {
        ...
        type: "color",
        category: "semantic-palette",
        description: "The color used to define danger states in meter elements and invalid inputs.",
    ...
    },
    {
        ...
        description: "Sets the background color on the html element, which is visible when scrolling past the beginning and end of the document.",
        default: "white",
    },
    {
    ...
    },
    {
        ...
        type: "color",
        category: "applied-colors",
        description: "Sets the border color for buttons and inputs that have the disabled attribute.",
        default: "hsl(220, 10%, 90%)",
    },
    {
    ...
    },
    {
        ...
        type: "color",
        category: "applied-colors",
        description: "Sets the text color for buttons and inputs that have the disabled attribute.",
        default: "hsl(220, 10%, 60%)",
    },
    {
        ...
        type: "number",
        category: "containers",
        description: "Sets the maximum width of elements with the .container class.",
    },
    {
        name: "--hiq-container-horizontal-gap",
        type: "number",
        category: "containers",
        description: "Sets the left and right gap between the container edge and the parent element.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "borders-outlines",
        description: "Sets the width of the outline that appears on focusable elements when focused (this is actually created with box-shadow).",
    },
    {
        name: "--hiq-outline-color",
        type: "color",
        category: "borders-outlines",
        description: "Sets the color of the outline that appears on focusable elements when focused.",
    ...
    },
    {
        ...
        description: "Sets the default transition speed for hover, focus and active states on links, buttons and inputs.",
    },
    {
        name: "--hiq-easing",
        type: "text",
        category: "animation-controls",
        description: "Defines the default easing curve for hover, focus, and active states on links, buttons and inputs.",
    },
    {
        name: "--hiq-text-rendering",
        type: "text",
        category: "global-typography-settings",
        description: "Sets the text-rendering property that tells the browser what to optimize for when rendering text.",
    },
    {
        name: "--hiq-letter-spacing-base",
        type: "number",
        category: "global-typography-settings",
        description: "The default letter-spacing assigned to the entire document.",
    },
    {
        name: "--hiq-text-color",
        type: "color",
    ...
    },
    {
        ...
        description: "Sets the default font family used for all elements, except for code, kbd, samp and pre.",
    },
    {
        name: "--hiq-font-family-monospace",
        type: "text",
        category: "font-families",
        description: "Sets the default monospaced font family, used in code, kbd, samp and pre elements.",
    },
    {
        name: "--hiq-unitless-min-font-size",
        type: "number",
        category: "responsive-typography",
        description: "The minimum font size in pixels. Type will be no smaller than this. Must not include the term 'px'.",
    },
    {
        name: "--hiq-unitless-max-font-size",
        type: "number",
        category: "responsive-typography",
        description: "The maximum font size in pixels. Type will be no larger than this. Must not include the term 'px'.",
    },
    {
        name: "--hiq-unitless-lower-font-range",
        type: "number",
        category: "responsive-typography",
        description: "The viewport width in pixels at which font size starts increasing. At smaller widths, type remains static. Must not include the term 'px'.",
    },
    {
        name: "--hiq-unitless-upper-font-range",
        type: "number",
        category: "responsive-typography",
        description: "The viewport width in pixels at which font size stops increasing. At larger widths, type remains static. Must not include the term 'px'.",
    },
    {
        name: "--hiq-font-size-1",
        type: "number",
        category: "type-scale",
        description: "First and largest size in the type scale. Applied by default to the h1 element.",
    },
    {
        name: "--hiq-font-size-2",
        type: "number",
        category: "type-scale",
        description: "Second size in the type scale. Applied by default to the h2 element.",
    },
    {
        name: "--hiq-font-size-3",
        type: "number",
        category: "type-scale",
        description: "Third size in the type scale. Applied by default to the h3 element.",
    },
    {
        name: "--hiq-font-size-4",
        type: "number",
        category: "type-scale",
        description: "Fourth size in the type scale. Applied by default to the h4 element.",
    },
    {
        name: "--hiq-font-size-5",
        type: "number",
        category: "type-scale",
        description: "Fifth size in the type scale. Applied by default to the h5 element.",
    },
    {
        name: "--hiq-font-size-6",
        type: "number",
        category: "type-scale",
        description: "Sixth size in the type scale. Applied by default to the h6 element.",
    },
    {
        name: "--hiq-font-size-base",
        type: "number",
        category: "type-scale",
        description: "Base font size for document. All inline elements and paragraphs receive this type size by default.",
    },
    {
        name: "--hiq-font-size-large",
        type: "number",
        category: "type-scale",
        description: "Size slightly larger than the base font size. Set to the fourth font size by default.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "headings",
        description: "The font weight assigned to h1, h2, h3, h4, h5, and h6 elements.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "font-weights",
        description: "Corresponds to a 'normal' font weight. The majority of elements receive this weight by default.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "font-weights",
        description: "The second-to-heaviest weight in the default font weight range.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "font-weights",
        description: "The font weight assigned to the majority of elements. This is set to the normal font weight by default.",
    },
    {
        name: "--hiq-mark-color",
        type: "color",
    ...
    },
    {
        ...
        type: "number",
        category: "blockquotes",
        description: "Sets the line-height for the p element within a blockquote.",
    },
    {
    ...
    },
    {
        ...
        type: "text",
        category: "links",
        description: "Sets the text decoration (underlined or otherwise) for anchor elements.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "user-input",
        description: "Sets the font weight for kbd elements that are nested within other kbd elements.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "figures",
        description: "Sets the top margin for figcaptions to separate them from the content of the figure.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "tables",
        description: "Sets the width of the bottom border on cells within the thead element.",
    },
    {
        ...
        type: "number",
        category: "tables",
        description: "Sets the width of the top border on cells within the tfoot element.",
    },
    {
        ...
        type: "number",
        category: "tables",
        description: "Sets the top and bottom padding on the caption element with a table.",
    },
    {
        ...
        type: "color",
        category: "tables",
        description: "Sets the text color on the caption element within a table.",
    },
    {
        ...
        type: "number",
        category: "tables",
        description: "Sets the font weight for the caption element within a table.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "forms",
        description: "Sets the bottom margin for the legend element used within a form.",
    },
    {
        ...
        type: "number",
        category: "forms",
        description: "Sets the font weight for the legend element used within a form.",
    },
    {
        ...
        type: "number",
        category: "forms",
        description: "Sets the bottom margin for the label element used within a form to separate it from its related input.",
    },
    {
        ...
        type: "number",
        category: "forms",
        description: "Sets the font weight for the label element used within a form.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "inputs",
        description: "Sets the border width on text inputs, selects and textareas.",
    },
    {
        ...
        type: "number",
        category: "inputs",
        description: "Sets the border radius on text inputs, selects and textareas.",
    },
    {
        ...
        type: "color",
        category: "inputs",
        description: "Sets the border color on static state text inputs, selects and textareas.",
    },
    {
        ...
        type: "color",
        category: "inputs",
        description: "Sets the background color on static state text inputs, selects and textareas.",
    },
    {
        ...
        type: "color",
        category: "inputs",
        description: "Sets the text color on static state text inputs, selects and textareas.",
    },
    {
        ...
        type: "color",
        category: "inputs",
        description: "Sets the placeholder text color on static state text inputs, selects and textareas.",
    },
    {
        ...
        type: "color",
        category: "inputs",
        description: "Sets the border color on hovered text inputs, selects and textareas.",
    },
    {
        ...
        type: "color",
        category: "inputs",
        description: "Sets the background color on hovered text inputs, selects and textareas.",
    },
    {
    ...
    },
    {
        ...
        type: "color",
        category: "inputs",
        description: "Sets the border color on focused text inputs, selects and textareas.",
    },
    {
        ...
        type: "color",
        category: "inputs",
        description: "Sets the background color on focused text inputs, selects and textareas.",
    },
    {
    ...
    },
    {
        ...
        type: "text",
        category: "selects",
        description: "Sets the background image on select elements. This controls the display of the down caret. By default, this is set to an inline svg.",
    },
    {
        ...
        type: "text",
        category: "selects",
        description: "Sets the positioning of the caret with relation to the select element.",
    },
    {
    ...
    },
    {
        ...
        type: "color",
        category: "selects",
        description: "Sets the background color on a selected option in a select element with the multiple attribute.",
    },
    {
        ...
        type: "number",
        category: "selects",
        description: "Sets the top and bottom padding on a select element with the multiple attribute.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "checkboxes",
        description: "Sets the left and right padding of the label following a checkbox input.",
    },
    {
        ...
        type: "number",
        category: "checkboxes",
        description: "Sets the font weight of the label following a checkbox input.",
    },
    {
    ...
    },
    {
        ...
        type: "color",
        category: "checkboxes",
        description: "Sets the border color of the visual checkbox element when the input is checked.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "checkboxes",
        description: "Sets the border width of the check mark within the checkbox.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "checkboxes",
        description: "Sets the width of the mark within an indeterminate checkbox.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "radio-buttons",
        description: "Sets the left and right padding of the label following a radio input.",
    },
    {
        ...
        type: "number",
        category: "radio-buttons",
        description: "Sets the font weight of the label following a radio input.",
    },
    {
    ...
    },
    {
        ...
        type: "color",
        category: "radio-buttons",
        description: "Sets the border color of the visual radio element when the input is checked.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "radio-buttons",
        description: "Sets the border-radius of the circle within the radio button.",
    },
    {
        ...
        type: "color",
        category: "radio-buttons",
        description: "Sets the background color of the circle within the radio button.",
    },
    {
    ...
    },
    {
        ...
        type: "number",
        category: "range-inputs",
        description: "Sets the border radius of the range input draggable handle.",
    },
    {
        ...
        type: "color",
        category: "range-inputs",
        description: "Sets the background color of the range input draggable handle.",
    },
    {
