module.exports = [
    ...
    },
    {
        name: ':--text-input',
        description:
            "input[type='text'], input[type='password'], input[type='url'], input[type='email'], input[type='tel'], input[type='search'], input[type='number'], input[type='date'], input[type='month'], input[type='week'], input[type='datetime-local']"
    },
    {
        name: ':--temporal-input',
        description:
